            ...
            <div className='flex justify-center items-center gap-20 mt-12'>
                ...
                <div>
                    <form ref={form} onSubmit={sendEmail}>
                        ...
                        <input className='w-[400px] my-2 rounded-lg px-5 py-2' type="text" placeholder='your full name' name="user_name" /><br />

                        <label className='text-white'>Email</label><br />
                        <input className='w-[400px] rounded-lg px-5 py-2 my-2' type="email" placeholder='your email' name="user_email" /><br />

                        <label className='text-white'>Message</label><br />
                        <textarea className='w-[400px] rounded-lg my-2 px-5 pt-2 pb-10' placeholder='message' name="message" /> <br />

                        <input className="w-[400px] text-white font-bold bg-orange-500 shadow-xl hover:border-b-4 hover:scale-105 transition-all px-8 py-2 mt-5 rounded-full" type='submit' value="Send" />
                    </form>
                </div>
            </div>
        </div>
