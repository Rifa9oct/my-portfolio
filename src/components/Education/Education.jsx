...
const Education = () => {
    return (
        <div className="max-w-[1280px] text-white mx-auto mt-[160px] md:mt-10 lg:mt-[120px] mb-20 lg:mb-[120px]" id="education">
            <div data-aos="fade-up"
                data-aos-duration="800" className="flex flex-col justify-center items-center">
                <img src={education} alt="education_icon" className='w-24' />
                < h1 className="text-4xl md:text-5xl font-extrabold font-serif" >Education</h1 >
            </div>
            ...
            <div className='flex flex-col lg:flex-row gap-[100px] lg:gap-8 justify-center mt-[130px]'>
                <div data-aos="zoom-in"
                    ...
                    className="relative w-[350px] md:w-[380px] mx-auto pt-[50px] border border-purple-400 shadow-inner shadow-gray-200 bg-[#9020aa] rounded-[20px] p-8 text-center">
